...
\item \NWtxtMacroDefBy\ \NWlink{nuweb6}{6}\NWlink{nuweb7}{, 7}\NWlink{nuweb10a}{, 10a}\NWlink{nuweb12a}{, 12a}\NWlink{nuweb14a}{, 14a}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb3}{3}.
\item \NWtxtIdentsDefed\nobreak\  \verb@get_interception_time@\nobreak\ \NWlink{nuweb8b}{8b}\NWlink{nuweb17a}{, 17a}.
\item{}
\end{list}
\end{minipage}\vspace{4ex}
\end{flushleft}
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb14a}{14a}.
\item \NWtxtIdentsUsed\nobreak\  \verb@get_current_speed_of_package@\nobreak\ \NWlink{nuweb16}{16}, \verb@get_interception_time@\nobreak\ \NWlink{nuweb10a}{10a}.
\item{}
\end{list}
\end{minipage}\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb18a}{} $\langle\,${\itshape Expand drone wavelets till an event of either Type \rnum{1} or Type \rnum{2} is detected}\nobreak\ {\footnotesize {18a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@pass@\\
...
\NWtarget{nuweb18b}{} $\langle\,${\itshape Update drone pool and package states}\nobreak\ {\footnotesize {18b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@pass@\\
...
\NWtarget{nuweb18c}{} $\langle\,${\itshape Run convex optimization solver to get improved tours for drones and packages}\nobreak\ {\footnotesize {18c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@pass@\\
...
\NWtarget{nuweb18d}{} $\langle\,${\itshape Plot movement of packages and drones if \verb|plot_tour_p == True |}\nobreak\ {\footnotesize {18d}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@pass@\\
...
\NWtarget{nuweb22}{} \verb@"README.md"@\nobreak\ {\footnotesize {22}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@    @\\
...
\NWtarget{nuweb23}{} \verb@"src/utils_graphics.py"@\nobreak\ {\footnotesize {23}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@    @\\
\mbox{}\verb@from matplotlib import rc@\\
...
\NWtarget{nuweb26}{} $\langle\,${\itshape Run Handlers}\nobreak\ {\footnotesize {26}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb33}{} $\langle\,${\itshape Plotting}\nobreak\ {\footnotesize {33}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
