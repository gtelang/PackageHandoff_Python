...
\item[D. \texttt{package\_trail\_info}]  is a list of list of dictionaries, similar to \verb|drone_wavelet_info|.  
     ...
     information conveniently from \verb|package_trail_info|. Again like \verb|get_last_wavelet_of_ith_drone| the 
...
\mbox{}\verb@@\\
\mbox{}\verb@def get_last_wavelet_of_ith_drone(i):@\\
...
\NWtarget{nuweb17a}{} $\langle\,${\itshape Construct bipartite graph $G$ on drone wavelets and package wavelets}\nobreak\ {\footnotesize {17a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@pass         @\\
...
\NWtarget{nuweb17b}{} $\langle\,${\itshape Get a bottleneck matching on $G$}\nobreak\ {\footnotesize {17b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@pass@\\
...
\NWtarget{nuweb17c}{} $\langle\,${\itshape Expand drone wavelets till an event of either Type \rnum{1} or Type \rnum{2} is detected}\nobreak\ {\footnotesize {17c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@pass@\\
...
\NWtarget{nuweb17d}{} $\langle\,${\itshape Update drone pool and package states}\nobreak\ {\footnotesize {17d}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@pass@\\
...
\NWtarget{nuweb17e}{} $\langle\,${\itshape Run convex optimization solver to get improved tours for drones and packages}\nobreak\ {\footnotesize {17e}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@pass@\\
...
\NWtarget{nuweb17f}{} $\langle\,${\itshape Plot movement of packages and drones if \verb|plot_tour_p == True |}\nobreak\ {\footnotesize {17f}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@pass@\\
...
\NWtarget{nuweb21}{} \verb@"README.md"@\nobreak\ {\footnotesize {21}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@    @\\
...
\NWtarget{nuweb22}{} \verb@"src/utils_graphics.py"@\nobreak\ {\footnotesize {22}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@    @\\
\mbox{}\verb@from matplotlib import rc@\\
...
\NWtarget{nuweb23}{} \verb@"src/utils_algo.py"@\nobreak\ {\footnotesize {23}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@import numpy as np@\\
...
\NWtarget{nuweb25}{} $\langle\,${\itshape Run Handlers}\nobreak\ {\footnotesize {25}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb32}{} $\langle\,${\itshape Plotting}\nobreak\ {\footnotesize {32}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
