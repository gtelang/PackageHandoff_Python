...
\mbox{}\verb@          print Fore.GREEN, "inum = ", inum, Style.RESET_ALL; inum += 1 @\\
...
\item[D. \texttt{package\_trail\_info}]  is a list of list of dictionaries, similar to \verb|drone_wavelets_info|.  
...
%{/python-mode}%
 ...
 is called because \verb|drone_wavelets_info| list is mutated during the main while loop.
...
\mbox{}\verb@        else : @\\
\mbox{}\verb@               print didx, current_handler_of_package, drone_locked_p[didx]@\\
...
\mbox{}\verb@               drone_locked_p[didx]= True #### tmp hacky fix@\\
\mbox{}\verb@@\\
\mbox{}\verb@print G_mat@\\
\mbox{}\verb@@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1.5ex}
...
\mbox{}\verb@plot_tour_multiple_packages (fig, ax, "Multiple Package Handoff", @\\
\mbox{}\verb@          sources, targets, drone_initposns, drone_speeds, drone_wavelets_info, package_trail_info)@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1.5ex}
\footnotesize
...
\mbox{}\verb@    drpatchSize  = 1.0 * stpatchSize@\\
\mbox{}\verb@@\\
\mbox{}\verb@    # Draw the source, target, and initial positions of the robots as bold dots@\\
\mbox{}\verb@    for source, target, stidx in zip(sources, targets, range(len(sources))):@\\
\mbox{}\verb@         xs,ys = extract_coordinates([source, target])@\\
\mbox{}\verb@         ax.plot(xs,ys, 'k--', alpha=0.3 ) # light line connecting source and target@\\
\mbox{}\verb@@\\
\mbox{}\verb@         ax.add_patch( mpl.patches.Circle( source, radius = stpatchSize, facecolor= cols[stidx], edgecolor='black', lw=1.0, **{'alpha': 0.4}  ))@\\
\mbox{}\verb@         ax.add_patch( mpl.patches.Circle( target, radius = stpatchSize, facecolor= cols[stidx], edgecolor='black', lw=1.0, **{'alpha': 0.4} ))@\\
\mbox{}\verb@@\\
...
\mbox{}\verb@         ax.add_patch( mpl.patches.Circle( (drone_initposns[idx][0], drone_initposns[idx][1]), @\\
\mbox{}\verb@                                           radius = drpatchSize, facecolor = 'gray', edgecolor = 'gray', lw=1.0,\@\\
\mbox{}\verb@                                          **{'alpha': 0.4} ))@\\
\mbox{}\verb@@\\
...
\mbox{}\verb@    for trail in package_trail_info:@\\
\mbox{}\verb@         xs, ys = extract_coordinates([d['current_position'] for d in trail])@\\
\mbox{}\verb@         print Fore.CYAN, "Printing Trail for package ", Style.RESET_ALL@\\
\mbox{}\verb@         utils_algo.print_list(zip(xs,ys))@\\
\mbox{}\verb@         plt.plot(xs,ys,'ro-')@\\
\mbox{}\verb@@\\
\mbox{}\verb@@\\
\mbox{}\verb@    # Plot the paths of the drones (all drone paths have the same color, make them thickish and transparent)@\\
\mbox{}\verb@    for dpath in drone_wavelets_info:@\\
\mbox{}\verb@         xs, ys = extract_coordinates([ d['wavelet_center'] for d in dpath ])            @\\
\mbox{}\verb@         print Fore.YELLOW, "Printing path of drone ", Style.RESET_ALL@\\
\mbox{}\verb@         utils_algo.print_list(zip(xs,ys))@\\
\mbox{}\verb@         plt.plot(xs,ys,'o-')@\\
\mbox{}\verb@@\\
\mbox{}\verb@    plt.show()@\\
\mbox{}\verb@@{\NWsep}
\end{list}
