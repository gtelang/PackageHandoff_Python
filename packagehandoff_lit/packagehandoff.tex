...
\mbox{}\verb@          @\hbox{$\langle\,${\itshape Get an exact / approximate bottleneck matching on $G$}\nobreak\ {\footnotesize ?}$\,\rangle$}\verb@@\\
\mbox{}\verb@          @\hbox{$\langle\,${\itshape Expand drone wavelets till an event of either Type \rnum{1} or \rnum{2} is detected}\nobreak\ {\footnotesize ?}$\,\rangle$}\verb@@\\
...
\item[B. \texttt{current\_package\_handler}]  is a list of integer indices where 
...
\item[C. \texttt{current\_package\_position}]  is a list of $(x,y)$ 
...
\item[D. \texttt{current\_package\_speed}] is a list keeping track of the current speed
...
\item[E. \texttt{drone\_wavelet\_info}] is a list of list of dictionaries. Each outer list 
     corresponds to a list of wavelets corresponding to each drone. Every wavelet is represented
     by a dictionary, with two attributes
\begin{description}
  \item[1. \texttt{wavelet\_center}] The cartesian coordinates of the center $H$ of the wavelet about which the wavelet expands
...
\end{description}
     ...
     and the time on the global clock (by the \verb|clock_time| attribute) 
     when the wavelet started expanding about the wavelet center.
...
\caption{A sequence of wavelets corresponding to a drone. Each wavelet expands around $H_i$ at speed $u_i$
...
\item[F. \texttt{drone\_pool}] is a list of ids of drones that can be 
...
\mbox{}\verb@drone_wavelet_info       = [ [{'wavelet_center': posn,'clock_time':0.0}] for posn in drone_initposns]@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1.5ex}
\footnotesize
...
\NWtarget{nuweb20}{} \verb@"README.md"@\nobreak\ {\footnotesize {20}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@    @\\
...
\NWtarget{nuweb22}{} \verb@"src/utils_algo.py"@\nobreak\ {\footnotesize {22}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@import numpy as np@\\
...
\NWtarget{nuweb24}{} $\langle\,${\itshape Run Handlers}\nobreak\ {\footnotesize {24}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb31}{} $\langle\,${\itshape Plotting}\nobreak\ {\footnotesize {31}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
