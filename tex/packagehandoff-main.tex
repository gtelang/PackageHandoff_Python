...
\item \NWtxtIdentsDefed\nobreak\  \verb@Single_PHO_Input@\nobreak\ \NWlink{nuweb15}{15}\NWlink{nuweb18}{, 18}\NWlink{nuweb20}{, 20}\NWlink{nuweb22}{, 22}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\item \NWtxtMacroDefBy\ \NWlink{nuweb7a}{7a}\NWlink{nuweb7b}{b}\NWlink{nuweb10}{, 10}\NWlink{nuweb11}{, 11}\NWlink{nuweb13}{, 13}\NWlink{nuweb14}{, 14}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb26}{26}.
\item \NWtxtIdentsDefed\nobreak\  \verb@algo_odw@\nobreak\ \NWlink{nuweb15}{15}\NWlink{nuweb18}{, 18}\NWlink{nuweb20}{, 20}\NWlink{nuweb22}{, 22}.\item \NWtxtIdentsUsed\nobreak\  \verb@time_of_travel@\nobreak\ \NWlink{nuweb7a}{7a}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb18}{} $\langle\,${\itshape PHO Experiments}\nobreak\ {\footnotesize {18}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\mbox{}\verb@@\\
\mbox{}\verb@         # Write data to YAML file@\\
\mbox{}\verb@         data = {'drone_info'  : drone_info,@\\
\mbox{}\verb@                 'source'      : source,@\\
\mbox{}\verb@                 'target'      : target,@\\
\mbox{}\verb@                 'used_drones' : used_drones, @\\
\mbox{}\verb@                 'odw_straight': {'package_trail': package_trail_straight,@\\
\mbox{}\verb@                                  'makespan'     : mspan_straight},@\\
\mbox{}\verb@@\\
\mbox{}\verb@                 'odw_cvx'     : {'package_trail': package_trail_cvx,@\\
\mbox{}\verb@                                  'makespan'     : mspan_cvx },@\\
\mbox{}\verb@                 'trivial_lower_bound': trivial_lower_bound}@\\
\mbox{}\verb@@\\
\mbox{}\verb@         subdir = 'data_exsize_'+str(exsize) + '_repnum_' + str(idx)@\\
\mbox{}\verb@         os.makedirs(dir + '/' + subdir)@\\
\mbox{}\verb@   @\\
\mbox{}\verb@         filename = dir + '/' + subdir + '/' + subdir + '.yml'@\\
\mbox{}\verb@         with open(filename, 'w') as outfile:@\\
\mbox{}\verb@             yaml.dump(data, outfile, default_flow_style=True)@\\
\mbox{}\verb@@\\
\mbox{}\verb@         eps = 1e-1@\\
\mbox{}\verb@         fig, ax = plt.subplots()@\\
\mbox{}\verb@         plot_tour(fig, ax, "Package Handoff: ODW Heuristic", @\\
\mbox{}\verb@                   source, target, drone_info, used_drones, @\\
\mbox{}\verb@                   package_trail_cvx, @\\
\mbox{}\verb@                   xlims=[-1-eps,1+eps], @\\
\mbox{}\verb@                   ylims=[-1-eps,1+eps], @\\
\mbox{}\verb@                   aspect_ratio=1.0)@\\
\mbox{}\verb@         print Fore.RED, "Saving figure to disk : ", idx, Style.RESET_ALL@\\
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroDefBy\ \NWlink{nuweb18}{18}\NWlink{nuweb20}{, 20}\NWlink{nuweb22}{, 22}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb26}{26}.
\item \NWtxtIdentsUsed\nobreak\  \verb@algo_odw@\nobreak\ \NWlink{nuweb7b}{7b}, \verb@Single_PHO_Input@\nobreak\ \NWlink{nuweb6}{6}.
\item{}
\end{list}
...
\NWtarget{nuweb20}{} $\langle\,${\itshape PHO Experiments}\nobreak\ {\footnotesize {20}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@  @\\
...
\NWtarget{nuweb22}{} $\langle\,${\itshape PHO Experiments}\nobreak\ {\footnotesize {22}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@  @\\
...
\item $\langle\,$PHO Algorithms\nobreak\ {\footnotesize \NWlink{nuweb7a}{7a}\NWlink{nuweb7b}{b}\NWlink{nuweb10}{, 10}\NWlink{nuweb11}{, 11}\NWlink{nuweb13}{, 13}\NWlink{nuweb14}{, 14}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb26}{26}.}
\item $\langle\,$PHO Data Structures\nobreak\ {\footnotesize \NWlink{nuweb6}{6}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb26}{26}.}
\item $\langle\,$PHO Experiments\nobreak\ {\footnotesize \NWlink{nuweb18}{18}\NWlink{nuweb20}{, 20}\NWlink{nuweb22}{, 22}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb26}{26}.}
\item $\langle\,$PHO Run Handlers\nobreak\ {\footnotesize \NWlink{nuweb15}{15}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb26}{26}.}
\end{list}}
\section{Chapter Index of Identifiers}

{\small\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \verb@algo_odw@: \underline{\NWlink{nuweb7b}{7b}}\NWlink{nuweb15}{, 15}\NWlink{nuweb18}{, 18}\NWlink{nuweb20}{, 20}\NWlink{nuweb22}{, 22}.
\item \verb@Single_PHO_Input@: \underline{\NWlink{nuweb6}{6}}\NWlink{nuweb15}{, 15}\NWlink{nuweb18}{, 18}\NWlink{nuweb20}{, 20}\NWlink{nuweb22}{, 22}.
\item \verb@single_pho_run_handler@: \underline{\NWlink{nuweb15}{15}}\NWlink{nuweb26}{, 26}.
...
\NWtarget{nuweb26}{} \verb@"../src/pho-main.py"@\nobreak\ {\footnotesize {26}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb30}{} \verb@"../src/utils_algo.py"@\nobreak\ {\footnotesize {30}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@    @\\
\mbox{}\verb@ @\\
...
\NWtarget{nuweb32}{} \verb@"../src/utils_graphics.py"@\nobreak\ {\footnotesize {32}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@    @\\
\mbox{}\verb@@\\
